<template>
  <el-form :model="form" status-icon :rules="rules" ref="form" label-width="100px" class="login-container">
    ...
    <h3 class="login_title">管理员账号密码皆为admin</h3>
    <h3 class="login_title">普通账号密码皆为user</h3>
    <el-form-item label="用户名" label-width="80px" prop="username" class="username">
      <el-input type="input" v-model="form.username" aotucomplete="off" placeholder="请输入账号"></el-input>
    </el-form-item>
